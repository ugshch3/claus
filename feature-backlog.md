...
### Task 6.11 — переработать отображение work - показывать не только последний ответ от llm, продумать варианты
- **Что нужно:** показывать N последних ответов, показывать все ответы, показывать свои запросы, показывать техническую информацию, - возможно еще какие то варианты

### Task 6.12 — сделать аналог /resume чатов
### Task 6.13 — сделать доступными / команды claude code в окне ввода
### Task 6.14 — что отображать для work в состоянии running?
### Task 6.15 — на новый экран добавить матрицу n x n. с возможностью пиннинга work.
