...
import { Project, Work, Settings, StreamEvent, RunResult } from '../../shared/types';
...
interface ElectronAPI {
  ...
  workCreate(params: { projectId: string; description: string; branchName: string }): Promise<Work>;
